...
@class Shofar_iOS_CustomRenderers_CustomTextFieldRenderer;
...
@class Xamarians_Media_iOS_AudioPickerController;
@class Xamarians_Media_iOS_ImagePickerController;
...
@interface Shofar_iOS_CustomRenderers_CustomTextFieldRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end
