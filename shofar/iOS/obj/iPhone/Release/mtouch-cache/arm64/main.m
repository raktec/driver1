...
extern void *mono_aot_module_Shofar_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_Shofar_info;
...
extern void *mono_aot_module_Xamarians_Media_info;
...
extern void *mono_aot_module_Xamarians_Media_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_Shofar_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_Shofar_info);
	...
	mono_aot_register_module (mono_aot_module_Xamarians_Media_info);
	...
	mono_aot_register_module (mono_aot_module_Xamarians_Media_iOS_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Xamarians.Media.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Shofar.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
